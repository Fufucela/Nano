...
def open_dagboek():
    ...
    def diary_entry():
        ...
        if check_if_date_exists(date_input):
            ...
            time.sleep(1)
            if user_choice == 'herschrijven': # als de gebruiker wilt herschrijven wordt er gevraagd de nieuwe tekst toe te voegen. Dit met de functie add_or_rewrite_entry
            ...
            text = input("Deze datum is nog niet ingevuld. Voer uw tekst in: ") # als de datum niet in het json bestand is gevonden. Wordt er gevraagd de tekst toe te voegen.
            time.sleep(1)
